(function($) {
    ...
    if ($("#clock").length) {
        $('#clock').countdown('2019/12/25', function(event) {
            ...
            + '<div class="box"><div>24</div> <span>years</span> </div>'
            + '<div class="box"><div>%H</div> <span>Days</span> </div>'
            + '<div class="box"><div>%M</div> <span>Hours</span> </div>'
            + '<div class="box"><div>%S</div> <span>Min</span> </div>'));
        });
    }
